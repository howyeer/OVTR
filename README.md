...
Use [./process/lvis_filter.ipynb](./process/lvis_filter.ipynb) to customize the annotation processing. Ensure [lvis_image_v1.json](https://drive.google.com/drive/folders/167IGC0Hkpnmpw7C95-AaPmWuVJZtC-q5?usp=drive_link) (which combines LVIS and COCO annotations) is prepared beforehand.
